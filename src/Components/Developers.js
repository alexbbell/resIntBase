...
//          choosePremix();
      ...
      const RemoveRow = (developer) => {
        ...
        const urlRemove = 'https://localhost:7245/api/Developers/' + developer.devcode;
                  ...
                  <table className="table table-striped">
                      ...
                      <tbody>
                          ...
                          {developersData.map(developer => (
                              <tr key={developer.devcode}>
                                  <td>{developer.devcode}</td>
                                  <td>
                                      <a href={developer.devcode}>{developer.name}</a>
                                      <br />
